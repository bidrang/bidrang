...
ReactQuery plays a pivotal role in this architecture. I created a custom React hook for each action, making data management seamless and efficient. ReactQuery's built-in caching and data synchronization capabilities ensure that data flows smoothly between the client and server.

## TypeScript and Axios for Robustness

The entire project is developed using TypeScript, adding a layer of type safety that prevents common runtime errors. For API calls, I rely on Axios, a versatile and widely adopted HTTP client, ensuring robust and reliable communication with the server.

## Navigating with React Router

For seamless navigation within the application, React Router comes into play. The "routes" folder in the project root contains different route configurations for both protected and public routes, each with its layout. This ensures a clean and organized routing structure.
